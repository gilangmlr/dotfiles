# Generated by Powerlevel10k configuration wizard on 2026-01-22 at 18:05 UTC.
...
() {
  ...
  # Was 'off' for code-server compatibility (no longer used). Set to 'quiet'
  # so the prompt appears instantly while plugins load in the background.
  # Using 'quiet' (not 'verbose') to suppress warnings from editor shell
  # integration scripts that may print to stdout during zsh init.
